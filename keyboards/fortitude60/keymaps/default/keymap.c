...
[_QWERTY] = LAYOUT( \
  ...
  KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                   KC_H,    KC_J,    KC_K,    KC_L,    JP_SCLN, JP_COLN, \
 ...
 * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |  英  |かな   |  F12 |      |      |      |      |      |
 * `-------------+------+------+------+------+------+------+------+------+------+------+-------------'
 *               |      |      |      |      |      |      |      |      |      |      |
 *               `---------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT( \
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   JP_PLUS, JP_MINS, JP_ASTR, JP_SLSH, JP_EQL, JP_YEN, \
  _______, _______, _______, _______, _______,  _______,                   JP_CIRC, JP_UNDS, JP_PIPE, _______, JP_AT, KC_BSPC,  \
  KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   _______, _______, _______, _______, _______, \
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  JP_MEISU, JP_MKANA, KC_F12,_______,_______,_______, _______, _______,\
